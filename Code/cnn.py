...
def getCNNModel():
    ...
    model.add(Conv2D(32, kernel_size = (3, 3), activation='relu', input_shape=(CONST.IMAGESIZE, CONST.IMAGESIZE, 3))) #convolution layer
    ...
    model.add(Dense(2, activation = 'sigmoid')) # classification using weights (might make sigmoid for better classification)
